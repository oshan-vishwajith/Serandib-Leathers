                ...
                <form action="" method="post">
                    ...
                    <div class="name">
                        <div>
                            ...
                            <input type="text" name="f_name" placeholder="Jhon">
                        </div>
                        <div>
                            <label for="l-name" >Last Name</label>
                            <input type="text" name="l_name" placeholder="Dove">
                        </div>
                    </div>
                    <div class="street">
                        <label for="name">Street</label>
                        <input type="text" name="address" placeholder="131/B, Avenue Road">
                    </div>
                    <div class="address-info">
                        <div>
                            <label for="city">City</label>
                            <input type="text" name="city" placeholder="Homagama">
                        </div>
                        <div>
                            <label for="state">District</label>
                            <input type="text" name="state" placeholder="Colombo">
                        </div>
                        <div>
                            <label for="zip">Zip</label>
                            <input type="text" name="zip" placeholder="10500">
                        </div>
                    </div>
...
if($order_result){
    ...
    $payment_sql="insert into payment (order_id,user_id,f_name,l_name,address,city,state,zip)
    values ('$last_id','$user_id','$f_name','$l_name','$address','$city','$state','$zip')";
