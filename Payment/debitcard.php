                ...
                <form action="" method="post">
                    ...
                    <div class="name">
                        <div>
                            ...
                            <input type="text" name="f_name" required placeholder="Jhon">
                        </div>
                        <div>
                            <label for="l-name" >Last Name</label>
                            <input type="text" name="l_name" required placeholder="Dove">
                        </div>
                    </div>
                    <div class="street">
                        <label for="name">Street</label>
                        <input type="text" name="address" required placeholder="131/B, Avenue Road">
                    </div>
                    <div class="address-info">
                        <div>
                            <label for="city">City</label>
                            <input type="text" name="city" required placeholder="Homagama">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="zip" required placeholder="10500">
                        </div>
                    </div>
                    <h1>
                    ...
                    <div class="cc-num">
                        ...
                        <input type="text" name="card_num" required placeholder="4568XXXX">
                    </div>

                    <div class="cc-num">
                        <label for="card-num">Card Holder Name</label>
                        <input type="text" name="card_name" required placeholder="Jhon Dove">
                    </div>
                    ...
                    <div class="cc-info">
                        <div>
                            ...
                            <input type="text" name="expire" required placeholder="12/29">
                        </div>
                        <div>
